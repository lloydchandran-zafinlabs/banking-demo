...
import com.zafin.bankingdemo.hello.api.GreetingMessage;
import com.zafin.bankingdemo.hello.api.HelloService;
import com.zafin.bankingdemo.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<com.zafin.bankingdemo.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      com.zafin.bankingdemo.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new com.zafin.bankingdemo.hello.api.HelloEvent.GreetingMessageChanged(
